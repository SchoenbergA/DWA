...
# load tables
old <- read.xlsx(file.path(wd,"table_for_control.xlsx")) # equal to act stand aus allen 4 tabs
new <- read.xlsx(file.path(wd,"table_for_control_AL.xlsx")) # weniger NA als old, aber auch mismatches
cle <- read.xlsx(file.path(wd,"DWA_unsure_cleaned.xlsx")) # unbekannt welcher stagte das ist
tes <- read.xlsx(file.path(wd,"table_for_control3.xlsx")) # act stand aus allen 4 tabs
